package com.challenger.modules.event;

import com.challenger.modules.account.CurrentAccount;
import com.challenger.modules.account.Account;
import com.challenger.modules.study.Study;
import com.challenger.modules.study.StudyRepository;
import com.challenger.modules.study.StudyService;
import com.challenger.modules.event.form.EventForm;
import com.challenger.modules.event.validator.EventValidator;
...
public class EventController {
    ...
    public String newEventSubmit(@CurrentAccount Account account,
        ...
        Event event = eventService.createEvent(
                modelMapper.map(eventForm, Event.class), study, account);
    ...
    public String checkInEnrollment(@CurrentAccount Account account,
                                    @PathVariable String path,
                                    @PathVariable("eventId") Event event,
                                    @PathVariable("enrollmentId") Enrollment enrollment) {
        Study study = studyService.getStudyToUpdate(account, path);
    ...
    public String cancelCheckInEnrollment(@CurrentAccount Account account,
                                          @PathVariable String path,
                                          @PathVariable("eventId") Event event,
                                          @PathVariable("enrollmentId") Enrollment enrollment) {
        Study study = studyService.getStudyToUpdate(account, path);
