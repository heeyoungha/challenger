package com.challenger.modules.study;

import com.challenger.modules.account.Account;
import com.challenger.modules.study.event.StudyCreatedEvent;
import com.challenger.modules.study.event.StudyUpdateEvent;
import com.challenger.modules.tag.Tag;
import com.challenger.modules.study.form.StudyDescriptionForm;
...
import static com.challenger.modules.study.form.StudyForm.VALID_PATH_PATTERN;
...
public class StudyService {
    ...
    public void updateStudyDescription(Study study, StudyDescriptionForm studyDescriptionForm) {
        ...
        eventPublisher.publishEvent(new StudyUpdateEvent(study, "모임 소개를 수정했습니다."));
    }
    ...
    public void close(Study study) {
        study.close();
        eventPublisher.publishEvent(new StudyUpdateEvent(study, "모임를 종료했습니다."));
    }
